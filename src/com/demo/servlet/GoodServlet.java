...
public class GoodServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("add".equals(action)) {//增加
            ...
            vo.setWupinName(Util.decode(request, "wupinName"));
            vo.setWupinNo(Util.decode(request, "wupinNo"));
            vo.setWupinCount(Util.decode(request, "wupinCount"));
            vo.setWupinType(Util.decode(request, "wupinType"));
            vo.setWupinGys(Util.decode(request, "wupinGys"));
            vo.setWupinGuige(Util.decode(request, "wupinGuige"));
            vo.setWupinPrice(Util.decode(request, "wupinPrice"));
            vo.setWupinText(Util.decode(request, "wupinText"));
